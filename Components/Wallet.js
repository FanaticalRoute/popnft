    ...
    <div className={css.mainCont} ref={elementClickSafe}>
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M40.0835 15.9978V19.0021C40.0835 19.8042 39.4418 20.4603 38.6251 20.4895H35.7668C34.1918 20.4895 32.7481 19.3374 32.6168 17.7624C32.5293 16.8437 32.8793 15.9833 33.4918 15.3853C34.0314 14.8312 34.7751 14.5104 35.5918 14.5104H38.6251C39.4418 14.5395 40.0835 15.1957 40.0835 15.9978Z"
            stroke="#292D32"
            strokeWidth="3"
            strokeLinecap="round"
            strokeLinejoin="round"
